...
const posts = [
  ...
  },
  {
    ...
    comments: [
      ...
      {
        userId: userIds[3],
        text: "Interesting, but could use more detail.",
        date: subDays(new Date(), 17),
      },
      {
        userId: userIds[4],
        text: "I agree with the points made.",
  ...
  },
  {
    ...
    comments: [
      ...
      {
        userId: userIds[1],
        text: "Could use more content.",
        date: subDays(new Date(), 14),
      },
      {
        userId: userIds[2],
        text: "Nice and concise.",
        date: subDays(new Date(), 21),
      },
      {
        userId: userIds[3],
        text: "Not sure what to make of this.",
  ...
  },
  {
    ...
    comments: [
      {
        userId: userIds[0],
        text: "Seems like you're ready for a break.",
        date: subDays(new Date(), 2),
      },
      {
        userId: userIds[1],
        text: "Good luck with the games!",
        date: subDays(new Date(), 9),
      },
      {
        userId: userIds[2],
        text: "Enjoy your gaming time!",
